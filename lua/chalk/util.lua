...
---@param hex string Color to saturate
---@param amount number Saturation amount (0.0-1.0)
---@return string Saturated color
function M.saturate(hex, amount)
  ...
  if diff == 0 then
    return hex -- No saturation change for grays
  end
  
  local factor = 1 + amount
  local mid = (max_val + min_val) / 2
...
---@param hex string Color to desaturate
---@param amount number Desaturation amount (0.0-1.0)
---@return string Desaturated color
